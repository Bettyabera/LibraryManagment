<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="membermanagment.aspx.cs" Inherits="WebApplication1.membermanagment" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           ...
                           <img width="100px" src="icons/avatar.png"/> 
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="ID"></asp:TextBox>
                               <asp:LinkButton class="btn btn-primary" ID="LinkButton4" runat="server"><i class="fa-sharp fa-regular fa-circle-check"></i></asp:LinkButton>
                     ...
                     <div class="col-md-5">
                       <label>Account Status</label>
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control mr-1" ID="TextBox7" runat="server" placeholder="Status" Visible="True" ReadOnly="True"></asp:TextBox>

                               <asp:LinkButton class="btn btn-success mr-1" ID="LinkButton1" runat="server"><i class="fa-sharp fa-regular fa-circle-check"></i></asp:LinkButton>

                               <asp:LinkButton class="btn btn-warning mr-1" ID="LinkButton2" runat="server"><i class="fa-solid fa-pause"></i></asp:LinkButton>
                  ...
                  <div class="row">
                     ...
                     <div class="col-8 mx-auto">
                        <asp:Button ID="Button4" class="btn btn-lg btn-block btn-danger" runat="server" Text="Delete User Permanently" />
                     </div>
                  </div>
               </div>
            </div>
